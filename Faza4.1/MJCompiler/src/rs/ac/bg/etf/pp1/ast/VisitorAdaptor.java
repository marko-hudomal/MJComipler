...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(IdentEqualConstant IdentEqualConstant) { }
    ...
    public void visit(IdentExprListArray IdentExprListArray) { visit(); }
    public void visit(SingleIdentExpr SingleIdentExpr) { visit(); }
    public void visit(Exprs Exprs) { visit(); }
    public void visit(Idents Idents) { visit(); }
    public void visit(DesignatorNode DesignatorNode) { visit(); }
    public void visit(NewArrayType NewArrayType) { visit(); }
    public void visit(ExprParenNode ExprParenNode) { visit(); }
    ...
    public void visit(DesignatorBraceActPars DesignatorBraceActPars) { visit(); }
    public void visit(DesignatorEmpty DesignatorEmpty) { visit(); }
    public void visit(TermFactor TermFactor) { visit(); }
    public void visit(TermNode TermNode) { visit(); }
    public void visit(SingleExpressionMinus SingleExpressionMinus) { visit(); }
    public void visit(SingleExpression SingleExpression) { visit(); }
    public void visit(ExpressionNode ExpressionNode) { visit(); }
    public void visit(CondFactExpressionRelopExpression CondFactExpressionRelopExpression) { visit(); }
    ...
    public void visit(ConditionTermNode ConditionTermNode) { visit(); }
    public void visit(SingleConditionTerm SingleConditionTerm) { visit(); }
    public void visit(ConditionTerms ConditionTerms) { visit(); }
    public void visit(ConditionNode ConditionNode) { visit(); }
    public void visit(SingleActualParam SingleActualParam) { visit(); }
    public void visit(ActualParametres ActualParametres) { visit(); }
    public void visit(NoActAprsNode NoActAprsNode) { visit(); }
    ...
    public void visit(ConditionNull ConditionNull) { visit(); }
    public void visit(ConditionNotNull ConditionNotNull) { visit(); }
    public void visit(DesignatorStatementNull DesignatorStatementNull) { visit(); }
    public void visit(DesignatorStatementNotNull DesignatorStatementNotNull) { visit(); }
    public void visit(ErrorIfElseStatement ErrorIfElseStatement) { visit(); }
    public void visit(IfConditionNode IfConditionNode) { visit(); }
    public void visit(IfStatementElse IfStatementElse) { visit(); }
    public void visit(IfStatementThen IfStatementThen) { visit(); }
    public void visit(ForMain ForMain) { visit(); }
    public void visit(ForStatement2 ForStatement2) { visit(); }
    public void visit(ForCondition ForCondition) { visit(); }
    public void visit(ForStatement1 ForStatement1) { visit(); }
    public void visit(ForHeader ForHeader) { visit(); }
    public void visit(SemiDerived1 SemiDerived1) { visit(); }
    public void visit(InBraceStatement InBraceStatement) { visit(); }
    ...
    public void visit(DesignatorStatementOnly DesignatorStatementOnly) { visit(); }
    ...
    public void visit(FormalParamDeclarationNoBrackets FormalParamDeclarationNoBrackets) { visit(); }
    public void visit(FormalParamDeclarationBrackets FormalParamDeclarationBrackets) { visit(); }
    ...
    public void visit(NoVoidType NoVoidType) { visit(); }
    public void visit(InterfaceMethodDeclarationWithParams InterfaceMethodDeclarationWithParams) { visit(); }
    public void visit(NoInterfaceMethodDeclaration NoInterfaceMethodDeclaration) { visit(); }
    public void visit(InterfaceMethodDeclarations InterfaceMethodDeclarations) { visit(); }
    public void visit(InterfaceDeclarationNode InterfaceDeclarationNode) { visit(); }
    public void visit(EnumerationVal EnumerationVal) { visit(); }
    public void visit(EnumerationNoVal EnumerationNoVal) { visit(); }
    public void visit(SingleEnumeration SingleEnumeration) { visit(); }
    public void visit(Enumerations Enumerations) { visit(); }
    public void visit(EnumIdent EnumIdent) { visit(); }
    public void visit(EnumDeclarationNode EnumDeclarationNode) { visit(); }
    public void visit(NoVarDeclaration NoVarDeclaration) { visit(); }
    public void visit(VarDeclarationList VarDeclarationList) { visit(); }
    public void visit(SinglType SinglType) { visit(); }
    public void visit(TypeListNode TypeListNode) { visit(); }
    public void visit(NoImplementation NoImplementation) { visit(); }
    public void visit(Implementation Implementation) { visit(); }
    public void visit(NoExtension NoExtension) { visit(); }
    public void visit(ErrorExtension ErrorExtension) { visit(); }
    public void visit(Extension Extension) { visit(); }
    public void visit(ClassVarDeclType ClassVarDeclType) { visit(); }
    public void visit(ErrorClassVarDecl ErrorClassVarDecl) { visit(); }
    public void visit(ClassVarDeclNode ClassVarDeclNode) { visit(); }
    public void visit(NoClassVarDeclaration NoClassVarDeclaration) { visit(); }
    public void visit(ClassVarDeclarationList ClassVarDeclarationList) { visit(); }
    public void visit(ClassDeclIdent ClassDeclIdent) { visit(); }
    public void visit(ClassDeclarationWithMethods ClassDeclarationWithMethods) { visit(); }
    public void visit(ClassDeclarationWithoutMethods ClassDeclarationWithoutMethods) { visit(); }
    public void visit(VariableBracket VariableBracket) { visit(); }
    public void visit(VariableNoBracket VariableNoBracket) { visit(); }
    ...
    public void visit(GlobalVarDeclNode GlobalVarDeclNode) { visit(); }
    public void visit(BooleanNode BooleanNode) { visit(); }
    public void visit(CharNode CharNode) { visit(); }
    public void visit(NumberNode NumberNode) { visit(); }
    public void visit(ErrorConstant ErrorConstant) { visit(); }
    public void visit(IdentEqualConstantNode IdentEqualConstantNode) { visit(); }
    ...
    public void visit(TypeNode TypeNode) { visit(); }
    public void visit(MethodLBRACE MethodLBRACE) { visit(); }
