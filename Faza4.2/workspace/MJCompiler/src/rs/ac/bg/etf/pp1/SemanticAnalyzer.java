...
//				}
	...
	public void visit(DesignatorStatementActPars designatorBrace) {
    	...
    	if(Obj.Meth == func.getKind()){
			report_info("Pronadjen poziv funkcije "  +MyPrint.printObjNode(func)+   " sa "+designatorBrace.getActPars().struct.getMembersTable().numSymbols()+"/"+func.getLocalSymbols().size()+" argumenta na liniji " + designatorBrace.getLine(), null);
