...
public interface Visitor { 
    ...
    public void visit(IdentExprListArray IdentExprListArray);
    public void visit(SingleIdentExpr SingleIdentExpr);
    ...
    public void visit(SingleExpressionMinus SingleExpressionMinus);
    ...
    public void visit(ErrorIfElseStatement ErrorIfElseStatement);
    public void visit(IfConditionNode IfConditionNode);
    public void visit(IfStatementElse IfStatementElse);
    public void visit(IfStatementThen IfStatementThen);
    public void visit(ForMain ForMain);
    public void visit(ForStatement2 ForStatement2);
    public void visit(ForCondition ForCondition);
    public void visit(ForStatement1 ForStatement1);
    public void visit(ForHeader ForHeader);
    public void visit(SemiDerived1 SemiDerived1);
    ...
    public void visit(InterfaceMethodIdent InterfaceMethodIdent);
    ...
    public void visit(InterfaceIdent InterfaceIdent);
    ...
    public void visit(ErrorExtension ErrorExtension);
    ...
    public void visit(ClassVariableBracket ClassVariableBracket);
    public void visit(ClassVariableNoBracket ClassVariableNoBracket);
    ...
    public void visit(ErrorClassVarDecl ErrorClassVarDecl);
    public void visit(ClassVarDeclNode ClassVarDeclNode);
    ...
    public void visit(ErrorConstant ErrorConstant);
    public void visit(IdentEqualConstantNode IdentEqualConstantNode);
    ...
    public void visit(MethodLBRACE MethodLBRACE);
