...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(AddopPerc AddopPerc) { visit(); }
    ...
    public void visit(NoIdentExpr NoIdentExpr) { visit(); }
    ...
    public void visit(NodeEmpty NodeEmpty) { visit(); }
    public void visit(Node Node) { visit(); }
    public void visit(ExprParenNode ExprParenNode) { visit(); }
    public void visit(NewEmpty NewEmpty) { visit(); }
    ...
    public void visit(NoSingleMinus NoSingleMinus) { visit(); }
    public void visit(SingleMinus SingleMinus) { visit(); }
    ...
    public void visit(ErrorDesignatorAssignExpresion ErrorDesignatorAssignExpresion) { visit(); }
    public void visit(DesignatorAssignExpresion DesignatorAssignExpresion) { visit(); }
    ...
    public void visit(ExprNull ExprNull) { visit(); }
    public void visit(ExprNotNull ExprNotNull) { visit(); }
    ...
    public void visit(CommaE CommaE) { visit(); }
    public void visit(SemiE SemiE) { visit(); }
    ...
    public void visit(EqualConstantNode EqualConstantNode) { visit(); }
